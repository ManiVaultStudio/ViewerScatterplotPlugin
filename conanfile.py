...
class ViewerScatterplotOPluginConan(ConanFile):
    ...
    name = "ViewerScatterplotPlugin"
    description = """Plugins for displaying viewerscatterplots
                  in the high-dimensional plugin system (HDPS)."""
    topics = ("hdps", "plugin", "image data", "loading")
    url = "https://github.com/hdps/ViewerScatterplotPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/ViewerScatterplotPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ViewerScatterplotPlugin")
        cmake.verbose = True
        return cmake
