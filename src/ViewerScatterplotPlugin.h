...
class ViewerScatterplotPlugin : public ViewPlugin
{
    Q_OBJECT

public:
    ViewerScatterplotPlugin(const PluginFactory* factory);
    ~ViewerScatterplotPlugin() override;
...
protected:
    ViewerScatterplotWidget* _scatterPlotWidget;
...
class ViewerScatterplotPluginFactory : public ViewPluginFactory
{
    Q_INTERFACES(hdps::plugin::ViewPluginFactory hdps::plugin::PluginFactory)
        Q_OBJECT
        Q_PLUGIN_METADATA(IID   "nl.tudelft.ViewerScatterplotPlugin"
            FILE  "ViewerScatterplotPlugin.json")

public:
    ViewerScatterplotPluginFactory(void) {}
    ~ViewerScatterplotPluginFactory(void) override {}
